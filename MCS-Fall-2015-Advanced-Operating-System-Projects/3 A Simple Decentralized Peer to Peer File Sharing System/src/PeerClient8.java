	...
	public static void main (String args[])
	{
		...
		try
		{
			...
			if (strKeyName != "")
			{
				...
				strPeerServerIP = "192.168.56.1";
				intPeerServerPort = 25700;
				strPeerDirectoryRelPath = "./Peer8";
				try
				{
					strPeerDirectoryPath = new File (strPeerDirectoryRelPath).getCanonicalPath()+"/";
				}
				...
				strPeerDownloadRelPath = "./Downloads8";
				try
				{
					strPeerDownloadPath = new File (strPeerDownloadRelPath).getCanonicalPath()+"/";
				}
				...
				strLogFileName = "./PeerServer8Log.txt";
			}
			else
			{
