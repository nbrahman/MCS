	...
	*/
	...
	public static void main (String args[])
	{
		...
		try
		{
			...
			strPeerServerIP = p2pProp.getProperty("strPeer3ServerIP");
			intPeerServerPort = Integer.parseInt(p2pProp.getProperty("intPeer3ServerPort"));
			String strPeerDirectoryRelPath = p2pProp.getProperty("strPeer3DirectoryPath");
			try
			{
			...
			String strPeerDownloadRelPath = p2pProp.getProperty("strPeer3DownloadPath");
			try
			{
			...
			strLogFileName = p2pProp.getProperty("strPeer3LogFileName");
		}
