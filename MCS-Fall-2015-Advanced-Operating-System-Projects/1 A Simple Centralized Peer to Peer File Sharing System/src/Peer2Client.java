	...
	*/
	...
	public static void main (String args[])
	{
		...
		try
		{
			...
			strPeerServerIP = p2pProp.getProperty("strPeer2ServerIP");
			intPeerServerPort = Integer.parseInt(p2pProp.getProperty("intPeer2ServerPort"));
			String strPeerDirectoryRelPath = p2pProp.getProperty("strPeer2DirectoryPath");
			try
			{
			...
			String strPeerDownloadRelPath = p2pProp.getProperty("strPeer2DownloadPath");
			try
			{
			...
			strLogFileName = p2pProp.getProperty("strPeer2LogFileName");
		}
